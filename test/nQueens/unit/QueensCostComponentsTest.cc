...
class QueensCostComponentTest : public CostComponentTest<unsigned int, std::vector<unsigned>, QueensStateManager, QueensCostComponent>
{
	...
	typedef CostComponentTest<unsigned int, std::vector<unsigned>, QueensStateManager, QueensCostComponent> abstractCostComponentTest;
