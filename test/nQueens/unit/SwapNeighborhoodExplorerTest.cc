...
class SwapNeighborhoodExplorerTest : public NeighborhoodExplorerTest<unsigned int, std::vector<unsigned>, Swap, QueensStateManager, SwapNeighborhoodExplorer>
{
	...
	typedef NeighborhoodExplorerTest<unsigned int, std::vector<unsigned>, Swap, QueensStateManager, SwapNeighborhoodExplorer> abstractNeighborhoodExplorerTest;
