...
#include <vector>
  ...
  class PrimaryDiagonalCostComponent : public CostComponent<int, std::vector<int>, int >
  {
  public:
    PrimaryDiagonalCostComponent(const int& in) : CostComponent<int, std::vector<int>, int >(in, 1, false, "PrimaryDiagonal") 
      {  }
