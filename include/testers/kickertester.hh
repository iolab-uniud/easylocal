...
namespace EasyLocal
{
  ...
  namespace Debug
  {
    ...
    : ComponentTester<Input, Output, State, CostStructure>(name), Core::CommandLineParameters::Parametrized(name, "Kicker tester parameters"), sm(sm), om(om), kicker(k), os(os)
    {
