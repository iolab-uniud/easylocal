...
namespace EasyLocal
{
  ...
  namespace Debug
  {
    ...
    public ChoiceReader
    {
      ...
      typedef typename NeighborhoodExplorer::EvaluatedMove EvaluatedMove;
    ...
    public:
      ...
      void PrintMoveCosts(const Input& in, const State &st, const EvaluatedMove &em) const
      {
    ...
    protected:
      ...
      Core::StateManager<Input, State, CostStructure> &sm;               /**< A reference to the attached  state manager. */
