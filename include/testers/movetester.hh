...
/** A Move Tester allows to test the behavior of a given
 ...
 @ingroup Testers
 */
template <class Input, class Solution, class Move, class CostStructure = Core::DefaultCostStructure<int>>
class MoveTester
...
public:
    MoveTester(const Input &in,
               ...
               Core::NeighborhoodExplorer<Input, Solution, Move, CostStructure> &ne,
               std::string name,
               Tester<Input, Solution, CostStructure> &t,
               std::ostream &o = std::cout);
    void RunMainMenu(Solution&st);
    void PrintNeighborhoodStatistics(const Solution &st) const;
    void PrintAllNeighbors(const Solution &st) const;
    void CheckNeighborhoodCosts(const Solution &st) const;
...
protected:
    ...
    const Input &in;
    Core::SolutionManager<Input, Solution, CostStructure> &sm;               /**< A pointer to the attached  state manager. */
    Core::NeighborhoodExplorer<Input, Solution, Move, CostStructure> &ne; /**< A reference to the attached neighborhood explorer. */
...
MoveTester<Input, Solution, Move, CostStructure>::MoveTester(const Input &in,
                                                             Core::SolutionManager<Input, Solution, CostStructure> &sm,
                                                             Core::NeighborhoodExplorer<Input, Solution, Move, CostStructure> &ne,
                                                             std::string name,
                                                             Tester<Input, Solution, CostStructure> &t,
                                                             std::ostream &os)
: ComponentTester<Input, Solution, CostStructure>(name), in(in), sm(sm), ne(ne), os(os), tolerance(std::numeric_limits<CFtype>::epsilon())
{
    t.AddMoveTester(*this);
}

template <class Input, class Solution, class Move, class CostStructure>
void MoveTester<Input, Solution, Move, CostStructure>::RunMainMenu(Solution& st)
{
    bool show_state;
    do
    {
 ...
 */
template <class Input, class Solution, class Move, class CostStructure>
bool MoveTester<Input, Solution, Move, CostStructure>::ExecuteChoice(Solution&st)
{
...
template <class Input, class Solution, class Move, class CostStructure>
void MoveTester<Input, Solution, Move, CostStructure>::PrintMoveCosts(const Solution &st, const EvaluatedMove<Move, CostStructure> &em) const
{
...
template <class Input, class Solution, class Move, class CostStructure>
void MoveTester<Input, Solution, Move, CostStructure>::CheckNeighborhoodCosts(const Solution &st) const
{
    EvaluatedMove<Move, CostStructure> em;
 ...
 */
template <class Input, class Solution, class Move, class CostStructure>
void MoveTester<Input, Solution, Move, CostStructure>::PrintNeighborhoodStatistics(const Solution &st) const
{
...
template <class Input, class Solution, class Move, class CostStructure>
void MoveTester<Input, Solution, Move, CostStructure>::PrintAllNeighbors(const Solution &st) const
{
    Move mv;
    ne.FirstMove(st, mv);
    do
...
template <class Input, class Solution, class Move, class CostStructure>
void MoveTester<Input, Solution, Move, CostStructure>::CheckRandomMoveDistribution(const Solution &st) const
{
    Move mv;
...
template <class Input, class Solution, class Move, class CostStructure>
void MoveTester<Input, Solution, Move, CostStructure>::CheckMoveIndependence(const Solution &st) const
{
    Move mv;
    std::vector<std::pair<Move, Solution>> reached_states;
...
template <class Input, class Solution, class Move, class CostStructure>
void MoveTester<Input, Solution, Move, CostStructure>::SetTolerance(double t)
{
    tolerance = t;
}
