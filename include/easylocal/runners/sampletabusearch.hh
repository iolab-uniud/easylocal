...
namespace EasyLocal {
  ...
  namespace Core {
    ...
    void SampleTabuSearch<Input, State, Move, CFtype>::SelectMove()
    {
      ...
      EvaluatedMove<Move, CFtype> em = this->ne.RandomBest(*this->p_current_state, samples, sampled, [this, aspiration](const Move& mv, const DefaultCostStructure<CFtype>& move_cost) {
