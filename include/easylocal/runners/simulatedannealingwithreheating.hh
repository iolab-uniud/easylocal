...
namespace EasyLocal
{
  ...
  namespace Core
  {
    ...
    template <class Input, class State, class Move, class CostStructure>
    void SimulatedAnnealingWithReheating<Input, State, Move, CostStructure>::InitializeRun(const Input& in)
    {
      SimulatedAnnealingEvaluationBased<Input, State, Move, CostStructure>::InitializeRun(in);
      reheats = 0;
     ...
     */
    template <class Input, class State, class Move, class CostStructure>
    void SimulatedAnnealingWithReheating<Input, State, Move, CostStructure>::CompleteMove(const Input& in)
    {
      SimulatedAnnealingEvaluationBased<Input, State, Move, CostStructure>::CompleteMove(in);
     ...
     */
    template <class Input, class State, class Move, class CostStructure>
    bool SimulatedAnnealingWithReheating<Input, State, Move, CostStructure>::StopCriterion() const
    {
