...
namespace EasyLocal {
  ...
  namespace Core {
    ...
    /** A Local Search Solver has an internal state, and defines the ways for
     ...
     @ingroup Solvers
     */
    template <class Input, class Output, class State, typename CFtype = int, class CostStructure = DefaultCostStructure<CFtype>>
    class AbstractLocalSearch
    : public Parametrized, public Solver<Input, Output, CFtype, CostStructure>, public Interruptible<int>
    {
    public:
      /** These methods are the unique interface of Solvers */
      virtual SolverResult<Input, Output, CFtype, CostStructure> Solve() throw (ParameterNotSet, IncorrectParameterValue) final;
      virtual SolverResult<Input, Output, CFtype, CostStructure> Resolve(const Output& initial_solution) throw (ParameterNotSet, IncorrectParameterValue) final;
    protected:
      ...
      virtual void Go() = 0;
      StateManager<Input, State, CFtype, CostStructure>& sm; /**< A pointer to the attached
                                               state manager. */
     ...
     */
    template <class Input, class Output, class State, typename CFtype, class CostStructure>
    AbstractLocalSearch<Input, Output, State, CFtype, CostStructure>::AbstractLocalSearch(const Input& in,
                                                                           StateManager<Input, State, CFtype, CostStructure>& e_sm,
                                                                           OutputManager<Input, Output, State>& e_om,
                                                                           std::string name,
    ...
    template <class Input, class Output, class State, typename CFtype, class CostStructure>
    void AbstractLocalSearch<Input, Output, State, CFtype, CostStructure>::RegisterParameters()
    {
     ...
     */
    template <class Input, class Output, class State, typename CFtype, class CostStructure>
    void AbstractLocalSearch<Input, Output, State, CFtype, CostStructure>::FindInitialState()
    {
    ...
    template <class Input, class Output, class State, typename CFtype, class CostStructure>
    void AbstractLocalSearch<Input, Output, State, CFtype, CostStructure>::InitializeSolve() throw (ParameterNotSet, IncorrectParameterValue)
    {
    ...
    template <class Input, class Output, class State, typename CFtype, class CostStructure>
    SolverResult<Input, Output, CFtype, CostStructure> AbstractLocalSearch<Input, Output, State, CFtype, CostStructure>::Solve() throw (ParameterNotSet, IncorrectParameterValue)
    {
    ...
    template <class Input, class Output, class State, typename CFtype, class CostStructure>
    SolverResult<Input, Output, CFtype, CostStructure> AbstractLocalSearch<Input, Output, State, CFtype, CostStructure>::Resolve(const Output& initial_solution) throw (ParameterNotSet, IncorrectParameterValue)
    {
      auto start = std::chrono::high_resolution_clock::now();
    ...
    template <class Input, class Output, class State, typename CFtype, class CostStructure>
    void AbstractLocalSearch<Input, Output, State, CFtype, CostStructure>::TerminateSolve()
    {}
  }
}
