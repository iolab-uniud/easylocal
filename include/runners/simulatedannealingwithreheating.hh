...
namespace EasyLocal
{
  namespace Core
  {
    ...
    class SimulatedAnnealingWithReheating : public SimulatedAnnealingEvaluationBased<StateManager, NeighborhoodExplorer>
    {
    public:
      UNPACK_MOVERUNNER_BASIC_TYPES()
      
      using SimulatedAnnealingEvaluationBased<StateManager, NeighborhoodExplorer>::SimulatedAnnealingEvaluationBased;
    ...
    protected:
      ...
      void CompleteMove(const Input& in) override
      {
        ...
        SimulatedAnnealingEvaluationBased<StateManager, NeighborhoodExplorer>::CompleteMove(in);
      ...
      {
        SimulatedAnnealingEvaluationBased<StateManager, NeighborhoodExplorer>::InitializeRun(in);
        reheats = 0;
