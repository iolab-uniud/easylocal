...
TrimodalSteepestDescent<Input,State,Move1,Move2,Move3,CFtype>::TrimodalSteepestDescent(const Input& in,
									StateManager<Input,State,CFtype>& sm,
									NeighborhoodExplorer<Input,State,Move1,CFtype>& ne1,
									NeighborhoodExplorer<Input,State,Move2,CFtype>& ne2,
									NeighborhoodExplorer<Input,State,Move3,CFtype>& ne3,
									std::string name)
        : TrimodalMoveRunner<Input,State,Move1,Move2,Move3,CFtype>(in, sm, ne1, ne2, ne3, name)
{}

template <class Input, class State, class Move1, class Move2, class Move3, typename CFtype>
void TrimodalSteepestDescent<Input,State,Move1,Move2,Move3,CFtype>::Print(std::ostream& os) const
{
...
*/
template <class Input, class State, class Move1, class Move2, class Move3, typename CFtype>
void TrimodalSteepestDescent<Input,State,Move1,Move2,Move3,CFtype>::SelectMove()
{    
    ...
    this->current_move_cost3 = this->ne3.BestMove(this->current_state, this->current_move3);
...
*/
template <class Input, class State, class Move1, class Move2, class Move3, typename CFtype>
void TrimodalSteepestDescent<Input,State,Move1,Move2,Move3,CFtype>::InitializeRun()
{
...
*/
template <class Input, class State, class Move1, class Move2, class Move3, typename CFtype>
void TrimodalSteepestDescent<Input,State,Move1,Move2,Move3,CFtype>::TerminateRun()
{
...
*/
template <class Input, class State, class Move1, class Move2, class Move3, typename CFtype>
bool TrimodalSteepestDescent<Input,State,Move1,Move2,Move3,CFtype>::StopCriterion()
{ 
  if (this->current_move_type == MOVE_1)
    ...
    return GreaterOrEqualThan(this->current_move_cost3,0);
}
...
*/
template <class Input, class State, class Move1, class Move2, class Move3, typename CFtype>
bool TrimodalSteepestDescent<Input,State,Move1,Move2,Move3,CFtype>::AcceptableMove()
{
  if (this->current_move_type == MOVE_1)
    ...
    return LessThan(this->current_move_cost3,0);
}
...
*/
template <class Input, class State, class Move1, class Move2, class Move3, typename CFtype>
void TrimodalSteepestDescent<Input,State,Move1,Move2,Move3,CFtype>::StoreMove()
{
    if (this->current_move_type == MOVE_1)
      {
...
#endif /*TRIMODALSTEEPESTDESCENT_HH_*/
